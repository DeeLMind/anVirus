...
$myGui = GUICreate("TreeView Set Line Color", 392, 254)
...
_GuiCtrlStatusBarSetText($Status,"Previous Hex RGB Treeview Line Color: " & _GUICtrlTreeViewSetLineColor ($treeview, $White),255)
