...
GUICreate("Tab Delete Item", 300, 200)  ; will create a dialog box that when displayed is centered
...
$button = GUICtrlCreateButton("Delete", 200, 130, 90, 30)
