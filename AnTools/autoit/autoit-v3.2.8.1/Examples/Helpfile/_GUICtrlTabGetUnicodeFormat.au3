...
GUICreate("Tab Get Unicode Format", 300, 200)  ; will create a dialog box that when displayed is centered
...
GUISetState()
If (_GUICtrlTabGetUnicodeFormat ($tab)) Then
	GUICtrlSetData($Status, "Unicode Format")
Else
	GUICtrlSetData($Status, "ANSI Characters")
EndIf
