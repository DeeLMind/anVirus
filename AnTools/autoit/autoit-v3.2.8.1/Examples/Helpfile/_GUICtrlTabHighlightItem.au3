...
GUICreate("Tab Highlight Item", 300, 200)  ; will create a dialog box that when displayed is centered
...
$button = GUICtrlCreateButton("Highlight", 200, 130, 90, 30)
...
While 1
	...
	Select
		...
		Case $msg = $button
			$bool = Not $bool
			_GUICtrlTabHighlightItem ($tab, 2, $bool)
	EndSelect
WEnd
