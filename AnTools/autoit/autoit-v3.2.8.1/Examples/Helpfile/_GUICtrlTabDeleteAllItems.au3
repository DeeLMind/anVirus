...
GUICreate("Tab Delete All Items", 300, 200)  ; will create a dialog box that when displayed is centered
...
$button = GUICtrlCreateButton("Delete All", 200, 130, 90, 30)
