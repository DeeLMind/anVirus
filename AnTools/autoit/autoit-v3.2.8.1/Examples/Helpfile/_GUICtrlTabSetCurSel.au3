...
Dim $msg, $Status, $current, $button, $item = 0

GUICreate("Tab Set Current Selection", 300, 200)  ; will create a dialog box that when displayed is centered
