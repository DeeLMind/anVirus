...
vbs scripts can be run from the command line

pdfstreamdumper.exe myscript.vbs

or through the Load -> Automation Script menu item.
See the sample scripts for how to use this stuff.

Objects you can access in the vbs scripts.
