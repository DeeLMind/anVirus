...
Function GetFolderFiles2(folderPath As String, Optional filter As String = "*", Optional retFullPath As Boolean = True, Optional recursive As Boolean = False) As String()
   ...
   If recursive Then
        folders() = GetSubFolders2(folderPath)
...
Private Sub FolderEngine(fldrpath As String, ary() As String, Optional filter As String = "*")
    ...
    files = GetFolderFiles2(fldrpath)
    folders = GetSubFolders2(fldrpath)
...
Function GetSubFolders2(folderPath As String, Optional retFullPath As Boolean = True) As String()
    Dim fnames() As String
    Dim fd As String
    
    If Not FolderExists(folderPath) Then
        'returns empty array if fails
        GetSubFolders2 = fnames()
        Exit Function
    End If
