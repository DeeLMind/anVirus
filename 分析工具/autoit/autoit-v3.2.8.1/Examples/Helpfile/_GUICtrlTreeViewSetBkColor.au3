...
$myGui = GUICreate("TreeView Set Back Color", 392, 254)
...
_GuiCtrlStatusBarSetText($Status,"Previous Hex RGB Treeview Back Color: " & _GUICtrlTreeViewSetBkColor ($treeview, $Turquoise),255)
