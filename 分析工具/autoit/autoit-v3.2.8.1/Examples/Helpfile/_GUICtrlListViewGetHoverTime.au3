...
GUICreate("ListView Get Hover Time", 392, 322)
...
$Status = GUICtrlCreateLabel("Hover Time:" & _GUICtrlListViewGetHoverTime ($listview), 0, 302, 392, 20, BitOR($SS_SUNKEN, $SS_CENTER))
GUISetState()
While 1
	$msg = GUIGetMsg()
	Select
