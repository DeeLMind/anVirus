...
Dim $myGui, $treeview, $generalitem, $displayitem, $aboutitem, $compitem, $useritem, $resitem, $otheritem
Dim $Status, $startlabel, $aboutlabel, $compinfo, $cancelbutton, $msg

$myGui = GUICreate("TreeView Get Back Color", 392, 254)
...
GUISetState()
_GuiCtrlStatusBarSetText($Status,"Hex RGB Treeview Back Color: " & _GUICtrlTreeViewGetBkColor ($treeview),255)
While 1
	$msg = GUIGetMsg()
	Select
