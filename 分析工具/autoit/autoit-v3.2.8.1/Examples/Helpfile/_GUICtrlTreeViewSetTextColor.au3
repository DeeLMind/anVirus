...
$myGui = GUICreate("TreeView Set Text Color", 392, 254)
...
_GuiCtrlStatusBarSetText($Status,"Previous Hex RGB Treeview Text Color: " & _GUICtrlTreeViewSetTextColor ($treeview, $Crimson),255)
