...
$myGui = GUICreate("TreeView Set Indent", 392, 254)
...
_GUICtrlTreeViewSetIndent ($treeview, 10)
GUISetState()
_GuiCtrlStatusBarSetText($Status,"Indent: " & _GUICtrlTreeViewGetIndent ($treeview) & " in pixels",255)
While 1
	$msg = GUIGetMsg()
	Select
